	...
	return (
		<div className="flex">
			<div className="m-auto flex">
				...
				<main className="size-full md:min-w-56 lg:min-w-72 max-w-3xl grow border-gray-200 sm:mx-1 sm:w-full sm:border-x-2 md:w-2/3 lg:mx-4 lg:p-4">
				...
				<aside className="block size-full md:min-w-56 lg:min-w-72 max-w-3xl grow border-gray-200 sm:mx-1 sm:w-full sm:border-x-2 md:w-2/3  lg:flex lg:p-4">
					{selectedAuthor && (
